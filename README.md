...
## Help
- [help_zombies](https://github.com/zombietimes/help_zombies)
...
- [Metamask : + Truffle](https://truffleframework.com/docs/truffle/getting-started/truffle-with-metamask)
- [Metamask : Ganache](https://medium.com/coinmonks/developing-ethereum-dapps-with-truffle-ganache-and-metamask-31bc5023ce91)
- [Metamask : ERC20](https://medium.com/verasity/how-to-set-up-your-metamask-erc20-wallet-8f1835894a21)

## My Ether Wallet : MEW 
- [My Ether Wallet : Official](https://www.myetherwallet.com/)
- [My Ether Wallet : ERC20](https://medium.com/@trillhub/how-to-create-a-myetherwallet-erc-20-compatible-wallet-9debda48e3d4)

## Trust Wallet
- [Trust Wallet : Official](https://trustwallet.com/ethereum-wallet)

# Crypto Currency
## ERC20
- [Etherscan](https://etherscan.io/tokens)
- [ERC20 : Token List](https://eidoo.io/erc20-tokens-list/)
- [ERC20 : Ethereum](https://hackernoon.com/ethereums-erc-20-tokens-explained-simply-88f5f8a7ae90)
- [ERC20 : Loom Network](https://medium.com/loom-network/plasmachain-integrates-with-top-100-erc20-tokens-enabling-lightning-fast-layer-2-stablecoin-fb9c99e879d4)
